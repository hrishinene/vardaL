  ...
  return (
    <BaseModal title={ABOUT_GAME_MESSAGE} isOpen={isOpen} handleClose={handleClose}>
      <p className="text-medium text-gray-500 dark:text-gray-300">
       ...
       <p className="text-medium text-gray-500 dark:text-gray-300"> शब्दक-३ मधील प्रचंड शब्दसूची <b><u><a href="https://bruhadkosh.org/">बृहद्कोशाच्या </a></u></b>सौजन्याने आपल्यापर्यंत आणण्यात येत आहे.
      </p>
