...
export const Keyboard: ({onChar, onDelete, onEnter, guesses}: Props) => JSX.Element = ({onChar, onDelete, onEnter, guesses}: Props) => {
...
<Key value="अं" onClick={onClick} status={charStatuses['अं']}/>
<Key value="अः" onClick={onClick} status={charStatuses['अः']}/>
</div>

<div className="flex justify-center mb-1">
<Key width={50.4} value="ENTER" onClick={onClick}> {ENTER_TEXT} </Key>
...
<Key value="ङ" onClick={onClick} status={charStatuses['ङ']}/>
<Key width={50.4} value="DELETE" onClick={onClick}> {DELETE_TEXT} </Key>
</div>
...
<Key value="ज्ञ" onClick={onClick} status={charStatuses['ज्ञ']}/>
<Key value="ऋ" onClick={onClick} status={charStatuses['ऋ']}/>
        ...
        // <div>
        //     <div className="flex justify-center mb-1">
        //         <Key width={70.4} value="ENTER" onClick={onClick}>
        //             {ENTER_TEXT}
        //         </Key>
        //         <Key value="अ" onClick={onClick} status={charStatuses['अ']}/>
        //         <Key value="आ" onClick={onClick} status={charStatuses['आ']}/>
        ...
        //         <Key value="उ" onClick={onClick} status={charStatuses['उ']}/>
        //         <Key value="ऊ" onClick={onClick} status={charStatuses['ऊ']}/>
        //         <Key width={70.4} value="DELETE" onClick={onClick}>
        //             {DELETE_TEXT}
        //         </Key>
        //     </div>
        //     <div className="flex justify-center mb-1">
